...
const manualStudyRubyTerms = [
  ...
  "殷王朝", "春秋時代", "戦国時代", "前漢", "後漢", "東晋", "中国南北朝時代", "五胡十六国", "五胡十六国時代", "五代十国時代", "北魏", "渤海", "扶南", "新羅", "高句麗", "百済", "阮朝",
  "雑穀", "牧畜", "諸侯", "抵抗勢力", "帝政", "共和政", "儒教", "仏教", "律令",
...
function applyStudyRuby(text) {
  ...
  const readings = new Map([...Object.entries(manualStudyRuby), ...Object.entries(manualPersonRuby)]);
